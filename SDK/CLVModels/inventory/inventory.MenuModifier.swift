...
extension CLVModels.Inventory {
    ...
    public class MenuModifier: Codable {

        /// Modifier id
        public var id: String?
        /// Reference to the modifier
        public var modifier: CLVModels.Base.Reference?
        ...
        /// If the menu modifier has been filtered by the filter microservice.
        ...
        required public init(from decoder: Decoder) throws {
            ...
            do {
                self.modifier = try rootContainer.decodeIfPresent(CLVModels.Base.Reference.self, forKey: .modifier)
            } catch {
                decodeError.append(error)
            }
            do {
