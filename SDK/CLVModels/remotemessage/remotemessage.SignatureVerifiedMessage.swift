...
extension CLVModels.Remotemessage {
    ...
    public class SignatureVerifiedMessage: Codable {
        ...
        required public init(from decoder: Decoder) throws {
            ...
            do {
                self.verified = try rootContainer.decodeIfPresent(Bool.self, forKey: .verified)
            } catch {
                decodeError.append(error)
            }
        }
        ...
        public func encode(to encoder: Encoder) throws {
            ...
            if (verified != nil) { try container.encode(verified, forKey: .verified) }
        }
    }
