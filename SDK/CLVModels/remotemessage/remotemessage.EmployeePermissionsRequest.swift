...
extension CLVModels.Remotemessage {
    ...
    public class EmployeePermissionsRequest: Codable {
        ...
        required public init(from decoder: Decoder) throws {
            ...
            do {
                self.permissions = try rootContainer.decodeIfPresent(String.self, forKey: .permissions)
            } catch {
                decodeError.append(error)
            }
            do {
                self.appPackage = try rootContainer.decodeIfPresent(String.self, forKey: .appPackage)
            } catch {
                decodeError.append(error)
            }
            do {
                self.showCancelButton = try rootContainer.decodeIfPresent(Bool.self, forKey: .showCancelButton)
            } catch {
                decodeError.append(error)
            }
        }
        ...
        public func encode(to encoder: Encoder) throws {
            ...
            if (appPackage != nil) { try container.encode(appPackage, forKey: .appPackage) }
            if (showCancelButton != nil) { try container.encode(showCancelButton, forKey: .showCancelButton) }
        }
    }
