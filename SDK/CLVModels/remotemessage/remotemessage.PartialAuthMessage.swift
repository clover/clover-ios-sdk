...
extension CLVModels.Remotemessage {
    ...
    public class PartialAuthMessage: Codable {
        ...
        /// Amount authorized
        public var partialAuthAmount: Int64?
        ...
        required public init(from decoder: Decoder) throws {
            ...
            do {
                self.partialAuthAmount = try rootContainer.decodeIfPresent(Int64.self, forKey: .partialAuthAmount)
            } catch {
                decodeError.append(error)
            }
        }
        ...
        public func encode(to encoder: Encoder) throws {
            ...
            if (partialAuthAmount != nil) { try container.encode(partialAuthAmount, forKey: .partialAuthAmount) }
        }
    }
