...
extension CLVModels.Remotemessage {
    ...
    public class OrderActionResponseMessage: Codable {
        ...
        public var orderActionResponse: CLVModels.Remotemessage.OrderActionResponse?
        ...
        required public init(from decoder: Decoder) throws {
            ...
            do {
                self.orderActionResponse = try rootContainer.decodeIfPresent(CLVModels.Remotemessage.OrderActionResponse.self, forKey: .orderActionResponse)
            } catch {
                decodeError.append(error)
            }
        }
        ...
        public func encode(to encoder: Encoder) throws {
            ...
            if (orderActionResponse != nil) { try container.encode(orderActionResponse, forKey: .orderActionResponse) }
        }
    }
