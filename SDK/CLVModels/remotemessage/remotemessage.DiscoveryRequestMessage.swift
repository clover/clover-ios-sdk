...
extension CLVModels.Remotemessage {
    ...
    public class DiscoveryRequestMessage: Codable {
        ...
        public var supportsOrderModification: CLVModels.Variant?
        ...
        enum CodingKeys: CodingKey {
            ...
            case supportsOrderModification
        }
        ...
        required public init(from decoder: Decoder) throws {
            ...
            do {
                self.supportsOrderModification = try rootContainer.decodeIfPresent(CLVModels.Variant.self, forKey: .supportsOrderModification)
            } catch {
                decodeError.append(error)
            }
        }
        ...
        public func encode(to encoder: Encoder) throws {
            ...
            if (supportsOrderModification != nil) { try container.encode(supportsOrderModification, forKey: .supportsOrderModification) }
        }
    }
