...
extension CLVModels.Remotemessage {
    ...
    public class KeyPressMessage: Codable {
        ...
        public var keyPress: CLVModels.Remotemessage.KeyPress?
        ...
        required public init(from decoder: Decoder) throws {
            ...
            do {
                self.keyPress = try rootContainer.decodeIfPresent(CLVModels.Remotemessage.KeyPress.self, forKey: .keyPress)
            } catch {
                decodeError.append(error)
            }
        }
