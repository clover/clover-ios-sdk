...
extension CLVModels.Remotemessage {
    ...
    public class OrderActionAddDiscountMessage: Codable {
        ...
        public var addDiscountAction: CLVModels.Remotemessage.AddDiscountAction?
        ...
        required public init(from decoder: Decoder) throws {
            ...
            do {
                self.addDiscountAction = try rootContainer.decodeIfPresent(CLVModels.Remotemessage.AddDiscountAction.self, forKey: .addDiscountAction)
            } catch {
                decodeError.append(error)
            }
        }
        ...
        public func encode(to encoder: Encoder) throws {
            ...
            if (addDiscountAction != nil) { try container.encode(addDiscountAction, forKey: .addDiscountAction) }
        }
    }
