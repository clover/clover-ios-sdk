...
extension CLVModels.Remotemessage {
    ...
    public class OrderActionRemoveLineItemMessage: Codable {
        ...
        public var removeLineItemAction: CLVModels.Remotemessage.RemoveLineItemAction?
        ...
        required public init(from decoder: Decoder) throws {
            ...
            do {
                self.removeLineItemAction = try rootContainer.decodeIfPresent(CLVModels.Remotemessage.RemoveLineItemAction.self, forKey: .removeLineItemAction)
            } catch {
                decodeError.append(error)
            }
        }
        ...
        public func encode(to encoder: Encoder) throws {
            ...
            if (removeLineItemAction != nil) { try container.encode(removeLineItemAction, forKey: .removeLineItemAction) }
        }
    }
