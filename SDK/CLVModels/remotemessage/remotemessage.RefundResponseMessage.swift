...
extension CLVModels.Remotemessage {
    ...
    public class RefundResponseMessage: Codable {
        ...
        public var reason: CLVModels.Remotemessage.ErrorCode?
        /// Detail message
        public var message: String?
        /// Transaction state (success|fail)
        public var code: CLVModels.Remotemessage.TxState?
        ...
        required public init(from decoder: Decoder) throws {
            ...
            do {
                self.reason = try rootContainer.decodeIfPresent(CLVModels.Remotemessage.ErrorCode.self, forKey: .reason)
            } catch {
                decodeError.append(error)
            }
            do {
            ...
            do {
                self.code = try rootContainer.decodeIfPresent(CLVModels.Remotemessage.TxState.self, forKey: .code)
            } catch {
                decodeError.append(error)
            }
        }
