...
extension CLVModels.Remotemessage {
    ...
    public class BalanceInquiryResponseMessage: Codable {
        ...
        public var cardDetails: CLVModels.Pay.PaymentRequestCardDetails?
        ...
        required public init(from decoder: Decoder) throws {
            ...
            do {
                self.cardDetails = try rootContainer.decodeIfPresent(CLVModels.Pay.PaymentRequestCardDetails.self, forKey: .cardDetails)
            } catch {
                decodeError.append(error)
            }
        }
        ...
        public func encode(to encoder: Encoder) throws {
            ...
            if (cardDetails != nil) { try container.encode(cardDetails, forKey: .cardDetails) }
        }
    }
