...
extension CLVModels.Remotemessage {
    ...
    public class LogMessage: Codable {
        ...
        public var logLevel: CLVModels.Remotemessage.LogLevelEnum?
        ...
        required public init(from decoder: Decoder) throws {
            ...
            do {
                self.logLevel = try rootContainer.decodeIfPresent(CLVModels.Remotemessage.LogLevelEnum.self, forKey: .logLevel)
            } catch {
                decodeError.append(error)
            }
            do {
                self.messages = try rootContainer.decodeIfPresent([String:String].self, forKey: .messages)
            } catch {
                decodeError.append(error)
            }
        }
        ...
        public func encode(to encoder: Encoder) throws {
            ...
            if (logLevel != nil) { try container.encode(logLevel, forKey: .logLevel) }
            if (messages != nil) { try container.encode(messages, forKey: .messages) }
        }
    }
