...
extension CLVModels.Remotemessage {
    ...
    public class OrderActionRemoveDiscountMessage: Codable {
        ...
        public var removeDiscountAction: CLVModels.Remotemessage.RemoveDiscountAction?
        ...
        required public init(from decoder: Decoder) throws {
            ...
            do {
                self.removeDiscountAction = try rootContainer.decodeIfPresent(CLVModels.Remotemessage.RemoveDiscountAction.self, forKey: .removeDiscountAction)
            } catch {
                decodeError.append(error)
            }
        }
        ...
        public func encode(to encoder: Encoder) throws {
            ...
            if (removeDiscountAction != nil) { try container.encode(removeDiscountAction, forKey: .removeDiscountAction) }
        }
    }
