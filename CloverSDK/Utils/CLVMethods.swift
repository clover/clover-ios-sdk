...
extension CLVSession {
  ...
  public class func getApps(params params: [String:String] = [:], filters: [String:String] = [:], expands: [String] = [], sorts: [String:CLVRequest.SortType] = [:], limit: UInt = 100, offset: UInt = 0, success: ([CLVModels.Apps.App]) -> Void, failure: (NSError) -> Void = {print($0)}) {
  ...
  public class func getMerchants(accountToken: String, params: [String:String] = [:], filters: [String:String] = [:], expands: [String] = [], sorts: [String:CLVRequest.SortType] = [:], limit: UInt = 100, offset: UInt = 0, success: ([CLVModels.Merchant.Merchant]) -> Void, failure: (NSError) -> Void = {print($0)}) {
  ...
  public class func getAccount(accountToken: String, params: [String:String] = [:], filters: [String:String] = [:], expands: [String] = [], sorts: [String:CLVRequest.SortType] = [:], limit: UInt = 100, offset: UInt = 0, success: (CLVModels.Account.Account?) -> Void, failure: (NSError) -> Void = {print($0)}) {
