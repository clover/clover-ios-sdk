...
open func encode(with aCoder: NSCoder) {
  ...
  aCoder.encode(approver, forKey: "approver")
...
open func encode(with aCoder: NSCoder) {
  ...
  aCoder.encode(customerUuid, forKey: "customerUuid")
  aCoder.encode(orderTypeId, forKey: "orderTypeId")
  ...
  aCoder.encode(authorizations, forKey: "authorizations")
}
...
public func mapping(map: Map) {
      id <- map["id"]
        ...
        device <- map["device"]
        authorizations <- map["authorizations.elements"]
  }
}
