...
public func mapping(map: Map) {
      id <- map["id"]
        ...
        discounts <- (map["discounts"], CLVArrayTransform<CLVModels.Order.Discount>())
        discountAmount <- map["discountAmount"]
        exchanged <- map["exchanged"]
        modifications <- (map["modifications"], CLVArrayTransform<CLVModels.Order.Modification>())
        refunded <- map["refunded"]
        isRevenue <- map["isRevenue"]
        taxRates <- (map["taxRates"], CLVArrayTransform<CLVModels.Inventory.TaxRate>())
        payments <- (map["payments"], CLVArrayTransform<CLVModels.Payments.LineItemPayment>())
  }
}
...
public func mapping(map: Map) {
      id <- map["id"]
        ...
        customers <- (map["customers"], CLVArrayTransform<CLVModels.Customers.Customer>())
        ...
        taxRates <- (map["taxRates"], CLVArrayTransform<CLVModels.Order.OrderTaxRate>())
        ...
        credits <- (map["credits"], CLVArrayTransform<CLVModels.Payments.Credit>())
        voids <- (map["voids"], CLVArrayTransform<CLVModels.Payments.Payment>())
        device <- map["device"]
  }
}
